...
namespace Gestion_de_Turnos_Medicos.CapaDeDatos
{
    public class TurnoDAL
    {
        ...
        public int RegistrarTurnoEmergencia(string nroOrden, int idPaciente, int idSintoma, string estadoActual)
        {
            using (var context = new dbTurnosMedicos())
            {
                ...
                return context.Database
                    .SqlQueryRaw<int>("EXEC sp_RegistrarTurnoEmergencia @NroOrden, @IdPaciente, @IdSintoma, @EstadoActual",
        ...
        public int CrearTurnoEspecialidad(int idPaciente, string nombreEspecialidad, DateTime fecha, string horario)
        {
            using (var context = new dbTurnosMedicos())
            {
                var pIdPaciente = new SqlParameter("@IdPaciente", idPaciente);
                ...
                return context.Database
                    .SqlQueryRaw<int>("EXEC sp_CrearTurnoEspecialidad @IdPaciente, @NombreEspecialidad, @Fecha, @Horario",
